      ...
      <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_420px]">
        <div className="rounded-2xl border border-dashed border-line px-6 py-16 text-center">
          ...
          <h2 className="mt-5 font-display text-[19px] font-extrabold">
            Prisijunk ir matyk visus savo užsakymus
          </h2>
          <p className="mx-auto mt-2 max-w-[46ch] text-[14px] leading-relaxed text-muted">
            Paskyroje saugoma visa pirkimų istorija, užsakymų numeriai, būsenos
            ir administratoriaus pastabos — nereikia nieko ieškoti el. pašte.
          </p>
          <ul className="mx-auto mt-6 max-w-[40ch] space-y-2 text-left text-[13.5px] text-muted">
            <li className="flex items-center gap-2">
              ...
              Visi užsakymai ir sąskaitų (INV) numeriai vienoje vietoje
            </li>
            <li className="flex items-center gap-2">
              <BadgeCheck size={15} className="text-live" />
              Realaus laiko būsena: laukiama · patvirtinta · išsiųsta
            </li>
            <li className="flex items-center gap-2">
              <BadgeCheck size={15} className="text-live" />
              Mokėjimą patvirtiname rankiniu būdu — be klaidų ir be sukčiavimo
            </li>
          </ul>
        </div>
        <AuthPanel />
    ...
    <div>
      <div className="panel flex flex-wrap items-center gap-5 rounded-2xl p-6">
        ...
        <div className="min-w-0">
          <div className="micro text-muted/70">Paskyra</div>
      ...
      <p className="mt-3 max-w-[62ch] text-[14.5px] leading-relaxed text-muted">
        Visi pirkimai, susieti su tavo paskyra. Kiekvienas užsakymas turi savo
        numerį — jį gali nurodyti Discord arba administratoriui ieškant tavo
        užsakymo.
      </p>
