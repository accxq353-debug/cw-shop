          ...
          {step === 0 ? (
            <form onSubmit={submitDetails} className="mt-8">
              ...
              <button
                ...
                className={`mt-7 flex w-full items-center justify-center gap-2 rounded-xl py-4 font-display text-[15px] font-extrabold transition-transform shadow-lg ${
                  isHighValue && !twoFactorVerified
                    ? "bg-white/20 text-muted cursor-not-allowed"
                    : "bg-white text-void hover:-translate-y-px hover:shadow-signal/20"
                } disabled:opacity-60`}
              >
            ...
            <div className="mt-8">
              ...
              <button
                ...
                className={`mt-6 flex w-full items-center justify-center gap-2 rounded-xl py-4 font-display text-[15px] font-extrabold transition-transform ${
                  proof
                    ? "bg-white text-void hover:-translate-y-px shadow-lg hover:shadow-signal/20"
