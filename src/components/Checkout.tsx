...
import { CopyField } from "@/components/CartView";
...
const STEPS = ["Duomenys", "Apmokėjimas", "Pristatymas"];
...
function Countdown({ from }: { from: string }) {
  ...
  return (
    <span className="num inline-flex items-center gap-2 rounded-full border border-line bg-white/[0.03] px-3.5 py-1.5 text-[13px]">
...
export default function Checkout() {
  const { resolved, totalCents, sessionKey, ready, clear } = useCart();
  const { user } = useUser();
        ...
        <aside className="panel h-fit rounded-2xl p-7 lg:sticky lg:top-28">
          <div className="flex items-center gap-4 border-b border-line pb-5">
            ...
            <div>
              ...
              <div className="text-[13px] text-muted">
                Mokėjimą tvirtina žmogus, ne robotas
              </div>
            </div>
          </div>
          ...
          <dl className="mt-6 space-y-3 text-[14px]">
            ...
            <div className="flex items-center justify-between border-t border-line pt-4">
              ...
              <dd className="num text-[34px] font-bold leading-none">
                {eur(total)}€
              </dd>
            </div>
          </dl>
          ...
          <ul className="mt-8 space-y-4 border-t border-line pt-6 text-[13.5px]">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                <span className="text-muted">
                  Prekę išsiunčiame patvirtinę mokėjimą
                </span>
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                ...
                <span className="text-muted">
                  Screenshot keliauja tiesiai į mūsų Discord kanalą
                </span>
              </span>
            </li>
          </ul>
        ...
        <section className="panel rounded-2xl p-7">
          ...
          {step === 0 ? (
            <form onSubmit={submitDetails} className="mt-8">
              <div className="micro text-signal">Duomenys</div>
              <h2 className="mt-2 display text-[clamp(1.8rem,4vw,2.4rem)]">
                Kur atsiųsti prekę?
              </h2>
              <p className="mt-3 text-[14px] leading-relaxed text-muted">
                Užsakymo patvirtinimą ir prekę siunčiame el. paštu. Jei patogiau
                — nurodyk Discord vardą, atsiųsime ir ten.
              </p>
              ...
              <button
                ...
                className="mt-7 flex w-full items-center justify-center gap-2 rounded-xl bg-white py-4 font-display text-[15px] font-extrabold text-void transition-transform hover:-translate-y-px disabled:opacity-60"
              >
                {busy ? "Kuriama…" : "Tęsti į apmokėjimą"}
            ...
            <div className="mt-8">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="mt-3 max-w-[48ch] text-[14px] leading-relaxed text-muted">
                  ...
                  duomenimis. Patvirtinęs mokėjimą, prekę atsiųsime į{" "}
              ...
              <div className="mt-6 rounded-xl border border-line bg-void p-5">
                <div className="flex items-center justify-between gap-3">
                  ...
                  {proof ? (
                    <span className="micro rounded-full bg-live/15 px-2.5 py-1 text-live">
                      Pridėta
                    </span>
                  ) : (
              ...
              <button
                ...
                className={`mt-6 flex w-full items-center justify-center gap-2 rounded-xl py-4 font-display text-[15px] font-extrabold transition-transform ${
                  proof
                    ? "bg-white text-void hover:-translate-y-px"
              ...
              <p className="mt-6 text-center text-[12.5px] leading-relaxed text-muted/70">
                Įrodymas siunčiamas į {SHOP_NAME} Discord kanalą — komanda
                įspėjama automatiškai.
              </p>
            </div>
          ) : null}
            ...
            <div className="mt-8">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="mt-3 max-w-[50ch] text-[14px] leading-relaxed text-muted">
                  ...
                  būdu — radę jį savo sąskaitoje, iš karto atsiųsime prekę į{" "}
                  <span className="text-ink">{order.email}</span>.
                </p>
              </div>
